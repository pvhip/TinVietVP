                ...
                <div className="row">
                    <div className="col-lg-8 mx-auto">
                        <div className="text-center">
                            <h1 className="mb-4 text-uppercase fw-normal section-title" style={{ fontWeight: 'bold', color: '#FEA100' }}>Hướng dẫn đặt hàng</h1>
                        </div>
                        <div className="mb-4">
                        ...
                        <div className="mb-4">
                            ...
                            <p>Tại trang "Xác nhận đặt hàng", khách hàng khách hàng có thể kiểm tra lại toàn bộ đơn hàng vừa đặt và có thể thay đổi trong thời gian được phép.</p>
